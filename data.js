...
今回は、先験的分析論、つまり「純粋悟性概念（＝私たちが経験を対象として理解するために、悟性がもともと備えているカテゴリー）は、なぜ経験に適用できるのか」という議論まで読み進めた。『純粋理性批判』のストーリーはざっくりと、Ⅰ「人間はどのように認識できるのか」を明らかにし、Ⅱ「その認識能力をどのように正しく用いるべきか」を論じる本であるように思う。カントは認識能力を、感性、悟性、理性の三つに分けて考える。今回読んだ範囲では、感性、悟性とは何か、そして悟性は感性によって与えられたものをどのように判断するのか、というところまで理解した。つまり、Ⅰの途中までということになる。細かな内容については、ぜひ本書を手に取って読んでみてほしい。
