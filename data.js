const BOOKS = [
  ...
  },
  {
    ...
    impressions: [
      {
        date: "26.7.12",
        text: `カントのことは少しだけ知っている。以前、<a href="https://www.youtube.com/@yurutetsugaku" target="_blank" rel="noopener noreferrer">ゆる哲学ラジオ</a>で勉強した。感性、悟性、理性。純粋悟性概念、アプリオリな綜合判断など。言葉自体は聞いたことがある。
